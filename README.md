...
This repository contains the main scripts used for the manuscript "Generative AI-guided in silico closed-loop optimization of deposition morphology for 3D bioprinting applications" (under review).
